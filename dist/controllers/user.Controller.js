...
const user_Models_1 = require("../models/user.Models"); // Assuming UserModel is the user model
...
const signUp = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existingUser = yield user_Models_1.UserModel.findOne({ email });
        if (existingUser) {
...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const isPasswordValid = yield (0, bcrypt_1.passwordCompare)(password, user.password);
        if (!isPasswordValid) {
            return (0, response_1.errorResMsg)(res, 400, "Invalid email or password");
        }
        // Generate JWT token
        const token = (0, isAuthenticated_1.createJwtToken)({ userId: user._id, role: user.role });
